//MARK: GITHUB Source URL: https://github.com/michaeltyson/TPKeyboardAvoiding
...
- (UIEdgeInsets)TPKeyboardAvoiding_contentInsetForKeyboard {
    ...
    NSString *controllerName = [prefs stringForKey:@"controllerName"];
    
    if([controllerName isEqualToString:@"FilterPopup"]){
